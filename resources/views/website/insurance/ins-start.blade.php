...
<section class="contact-us">
 ...
 ' : '' }}</h2>
                        ...
                        <form class="form" method="post" autocomplete="off" action="{{ route('ins_session_store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <div class="form-group">
                                        <input name="phone" type="text" placeholder="{{ _lang('Mobile number') }}" class="wow animate__zoomIn" data-wow-delay=".4s" autocomplete="off" required>
